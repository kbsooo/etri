...
TARGET_CANDIDATES: dict[str, list[CandidateSpec]] = {
    "Q1": [
        ...
        CandidateSpec("only_missingness", "residual_ridge", 0.05),
    ...
    "Q2": [
        ...
        CandidateSpec("no_ratio", "residual_ridge", 0.05),
    ...
    "S1": [
        CandidateSpec("only_rhythm", "hgb", 0.20),
        CandidateSpec("no_temporal_delta", "residual_ridge", 0.10),
    ...
    "S3": [
        ...
        CandidateSpec("only_missingness", "residual_ridge", 0.10),
...
def main() -> None:
    ...
    write_prediction(output_dir / "oof_nested_residual_hybrid_decoder.csv", train, oof, oof=True)
    write_prediction(output_dir / "submission_nested_residual_hybrid_decoder.csv", sample, sample_pred, oof=False)
    report = {
        "avg_log_loss": avg,
    ...
    lines = [
        "# Nested Residual Hybrid Decoder",
        "",
        "Nested validation of stable consensus sources plus residual-state and extended-family candidates.",
        "",
        "## Score",
        "",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Nested validation for stable consensus plus residual-state hybrid candidates.")
    parser.add_argument("--train-path", default="data/ch2026_metrics_train.csv")
    parser.add_argument("--sample-path", default="data/ch2026_submission_sample.csv")
    parser.add_argument("--output-dir", default="outputs/nested_residual_hybrid_decoder_v1")
