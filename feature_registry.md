...
- Adopt if: a later pure mixmin-anchored structural/combo-tail selector predicts the same Q2/S3 sign while preserving hidden/world/block support and crossing margin without broad all-target movement.
- Drop if: future pure Q2/S3 structural gates remain sub-margin, or if public LB rejects a clean pure sparse-gate file.
...
- Policy: keep `q2_s3_sparse_gate_energy` as a diagnostic latent, not a direct submission feature. Do not submit E74/E75 as simple follow-ups; require a pure structural/combo-tail gate.
...
- Adopt if: a future gate can lift pure mixmin-anchored Q2/S3 above selector margin without adding non-Q2/S3 movement or violating combo tails.
- Drop if: pure Q2/S3 remains sub-margin across structural gates or public rejects a clean pure-graft submission.
...
- Policy: add `e73_public_scope_split_energy`. Use it to veto direct E74/E75 follow-ups and to require pure structural/combo-tail gates for any future Q2/S3 submission.
