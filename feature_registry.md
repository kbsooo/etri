...
- Label vs split test: valid as a public-free materialization and integrity test. It is not an OOF feature because the union itself was not generated by a single trainable OOF policy.
- Current evidence: E251 finds E237 `25`, E250 `21`, shared `15`, E237-only `10`, E250-only `6`, union `31`. Union stress score is `0.077866812`, above E237 `0.058941606` and E250 `0.053008707`, with support gain `0.010353010`. The shared intersection fails and E250-only fails. E252 materializes a schema-clean union file changing only Q3.
- Policy: F212 can create public sensors, not certified feature additions. Use E252 only when testing multi-view complementarity; keep E237 first for expected score until union OOF provenance or public feedback exists.
