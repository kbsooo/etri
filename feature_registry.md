...
- Direct JEPA residual probability movement is banned at raw/full amplitude. Only tiny scaled steps that pass broadness, bad-axis geometry, negative controls, context-alignment diagnostics, and public-sensor framing are allowed; E166 is the first such broad-escape sensor, not a general JEPA submission license. E167 adds a hard caveat: context-real is not the same as safety-certified.
