...
| `reproducibility_contract` | `PASS` | required missing 0, public ledger rows 26, raw/source records 140 | The team runner is reproducible from local artifacts, but it explicitly uses a public-LB sensor. |
