...
| `derived_module` | `41` | `0` | 재생성 가능한 코드 모듈 |
| `generated_output` | `177` | `0` | one-command runner가 만든 산출물 |
...
| `python_module` | `True` | `True` | `sleep_competition_adapter/core_health_calibrated_release.py` | reproducible module in the role-based HS-JEPA package |
| `python_module` | `True` | `True` | `sleep_competition_adapter/cross_listener_transport_decoder.py` | reproducible module in the role-based HS-JEPA package |
...
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_readout.json` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_readout_ko.md` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_cells.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_null_stress.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/core_health_calibrated_release/submission_hsjepa_core_health_benchmark_guarded_full_plus_8a3662bc_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/core_health_calibrated_release/submission_hsjepa_core_health_route_pressure_boundary_probe_e8b904e5_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/core_health_calibrated_release/submission_hsjepa_core_health_health_relaxed_pressure_sensor_7da82c23_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `submission_hsjepa_core_health_benchmark_guarded_full_plus_8a3662bc_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `submission_hsjepa_core_health_route_pressure_boundary_probe_e8b904e5_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `submission_hsjepa_core_health_health_relaxed_pressure_sensor_7da82c23_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_readout.json` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_readout_ko.md` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_cells.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_null_stress.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_listener_confirmed_shadow_660faef3_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_objective_listener_island_probe_8d2046bf_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_row_s2_transport_pressure_d94f8a8e_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_strict_listener_recalibrated_217acb61_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `submission_hsjepa_cross_listener_transport_listener_confirmed_shadow_660faef3_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `submission_hsjepa_cross_listener_transport_objective_listener_island_probe_8d2046bf_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `submission_hsjepa_cross_listener_transport_row_s2_transport_pressure_d94f8a8e_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
| `team_package_output` | `True` | `False` | `submission_hsjepa_cross_listener_transport_strict_listener_recalibrated_217acb61_uploadsafe.csv` | generated by run_full_team_hsjepa_package.py |
