...
Replace the public-sensor row-target assignment teacher with an OG-only personal/cohort/time human-state teacher while preserving the invariant-decoder and anti-shortcut gates.
