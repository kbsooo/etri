...
| `executable_core_benchmark` | `PASS` | Core module benchmark status core_module_benchmark_ready; scenarios 5; full-core F1 1.0000; action-health removal FP lift 9; invariant removal FP lift 1. | HS-JEPA has a small architecture-level behavioral test that does not depend on sleep labels or public LB. |
