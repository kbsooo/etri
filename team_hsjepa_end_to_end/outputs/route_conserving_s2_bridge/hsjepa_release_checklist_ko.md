...
| `big_bet_queue_high_ceiling` | `PASS` | status=big_bet_queue_ready, count=7 |
...
| `pipeline_manifest_complete` | `PASS` | status=pipeline_ready_with_boundary, stages=24, edges=50 |
