...
MODULES = [
    ...
    "hsjepa_core/run_core_module_benchmark.py",
    ...
    "sleep_competition_adapter/core_mediated_action_release.py",
    "sleep_competition_adapter/core_release_ablation_probe.py",
    "sleep_competition_adapter/core_health_calibrated_release.py",
    "sleep_competition_adapter/cross_listener_transport_decoder.py",
...
GENERATED_OUTPUTS = [
    ...
    ("hsjepa_core/outputs/hsjepa_core_module_benchmark.json", False),
    ("hsjepa_core/outputs/hsjepa_core_module_benchmark_ko.md", False),
    ("hsjepa_core/outputs/hsjepa_core_module_benchmark_cases.csv", False),
    ...
    ("sleep_competition_adapter/outputs/core_mediated_action_release/core_mediated_action_release_readout.json", False),
    ("sleep_competition_adapter/outputs/core_mediated_action_release/core_mediated_action_release_readout_ko.md", False),
    ("sleep_competition_adapter/outputs/core_mediated_action_release/core_mediated_action_release_cells.csv", False),
    ("sleep_competition_adapter/outputs/core_mediated_action_release/core_mediated_action_release_null_stress.csv", False),
    ("sleep_competition_adapter/outputs/core_mediated_action_release/submission_hsjepa_core_mediated_core_consensus_shadow_plus_3b0b1d0f_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_mediated_action_release/submission_hsjepa_core_mediated_core_boundary_balanced_3b003319_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_mediated_action_release/submission_hsjepa_core_mediated_core_route_rescue_a37f6054_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_mediated_action_release/submission_hsjepa_core_mediated_core_jury_veto_a37f6054_uploadsafe.csv", False),
    ("submission_hsjepa_core_mediated_core_consensus_shadow_plus_3b0b1d0f_uploadsafe.csv", False),
    ("submission_hsjepa_core_mediated_core_boundary_balanced_3b003319_uploadsafe.csv", False),
    ("submission_hsjepa_core_mediated_core_route_rescue_a37f6054_uploadsafe.csv", False),
    ("submission_hsjepa_core_mediated_core_jury_veto_a37f6054_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/core_release_ablation_probe_readout.json", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/core_release_ablation_probe_readout_ko.md", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/core_release_ablation_probe_cells.csv", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/core_release_ablation_probe_null_stress.csv", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/submission_hsjepa_core_ablation_full_core_reference_513175a1_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/submission_hsjepa_core_ablation_invariant_only_6edb3385_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/submission_hsjepa_core_ablation_no_action_health_043b20c7_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/submission_hsjepa_core_ablation_no_invariant_energy_363ccea6_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_release_ablation_probe/submission_hsjepa_core_ablation_no_listener_responsibility_d2560dc4_uploadsafe.csv", False),
    ("submission_hsjepa_core_ablation_full_core_reference_513175a1_uploadsafe.csv", False),
    ("submission_hsjepa_core_ablation_invariant_only_6edb3385_uploadsafe.csv", False),
    ("submission_hsjepa_core_ablation_no_action_health_043b20c7_uploadsafe.csv", False),
    ("submission_hsjepa_core_ablation_no_invariant_energy_363ccea6_uploadsafe.csv", False),
    ("submission_hsjepa_core_ablation_no_listener_responsibility_d2560dc4_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_readout.json", False),
    ("sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_readout_ko.md", False),
    ("sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_cells.csv", False),
    ("sleep_competition_adapter/outputs/core_health_calibrated_release/core_health_calibrated_release_null_stress.csv", False),
    ("sleep_competition_adapter/outputs/core_health_calibrated_release/submission_hsjepa_core_health_benchmark_guarded_full_plus_8a3662bc_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_health_calibrated_release/submission_hsjepa_core_health_route_pressure_boundary_probe_e8b904e5_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/core_health_calibrated_release/submission_hsjepa_core_health_health_relaxed_pressure_sensor_7da82c23_uploadsafe.csv", False),
    ("submission_hsjepa_core_health_benchmark_guarded_full_plus_8a3662bc_uploadsafe.csv", False),
    ("submission_hsjepa_core_health_route_pressure_boundary_probe_e8b904e5_uploadsafe.csv", False),
    ("submission_hsjepa_core_health_health_relaxed_pressure_sensor_7da82c23_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_readout.json", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_readout_ko.md", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_cells.csv", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/cross_listener_transport_null_stress.csv", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_listener_confirmed_shadow_660faef3_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_objective_listener_island_probe_8d2046bf_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_row_s2_transport_pressure_d94f8a8e_uploadsafe.csv", False),
    ("sleep_competition_adapter/outputs/cross_listener_transport_decoder/submission_hsjepa_cross_listener_transport_strict_listener_recalibrated_217acb61_uploadsafe.csv", False),
    ("submission_hsjepa_cross_listener_transport_listener_confirmed_shadow_660faef3_uploadsafe.csv", False),
    ("submission_hsjepa_cross_listener_transport_objective_listener_island_probe_8d2046bf_uploadsafe.csv", False),
    ("submission_hsjepa_cross_listener_transport_row_s2_transport_pressure_d94f8a8e_uploadsafe.csv", False),
    ("submission_hsjepa_cross_listener_transport_strict_listener_recalibrated_217acb61_uploadsafe.csv", False),
