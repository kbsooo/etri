...
Primary candidate: `drift_consistency_overshoot`
...
| --- | ---: | ---: | ---: | ---: | --- |
| certified_replay | 202 | 404 | 202 | 202 | True |
| drift_consistency_overshoot | 202 | 404 | 202 | 202 | True |
...
| id02 | -1 | 0.083333 | -0.660000 | 0.125000 | -0.190000 |
| id03 | 1 | 0.253676 | 0.834932 | -0.044118 | 0.190000 |
| id04 | 1 | 0.333744 | 0.858583 | 0.113300 | 0.265538 |
| id05 | 0 | -0.409091 | 0.000000 | 0.000000 | 0.000000 |
| id06 | 1 | 0.541667 | 0.920000 | 0.583333 | 0.330000 |
| id07 | -1 | -0.306667 | -0.850585 | 0.183333 | -0.190000 |
| id08 | -1 | 0.000000 | -0.760000 | -0.178571 | -0.274490 |
| id09 | 1 | 0.271429 | 0.840176 | -0.021429 | 0.190000 |
| id10 | -1 | -0.033088 | -0.769774 | -0.220588 | -0.280252 |

## 해석

`certified_replay`는 0.564749 계열을 재현하기 위한 control이다. `drift_consistency_overshoot`는 같은 방향을 더 세게 미는 것이 아니라, train drift가 뒷받침하는 subject에서만 더 크게 움직이고 충돌 subject는 줄이는 HS-JEPA action decoder다.
