...
| Private-safe invariant `z_private` | Needed for 0.53 | Not solved |
...
| Private-safe factorization | Weak | This is the main 0.53 bottleneck |
| End-to-end HS-JEPA v1 | Incomplete | Current system is a modular prototype |
