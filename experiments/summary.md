...
- Next step: test tiny GRU/Transformer sequence encoders with `d_model` 2/4/8 and the same tiny-decoder/nested discipline against the fixed latent floor (`0.624475`).
