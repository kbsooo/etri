...
- Next step: test tiny GRU with the same 30-minute token views and compare whether recurrent compression can beat the fixed expanded-latent floor (`0.624475`) without relying on targetwise selection.
