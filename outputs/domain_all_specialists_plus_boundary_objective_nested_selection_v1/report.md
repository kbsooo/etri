...
- Nested selected avg fold loss: `0.618892`
- Delta vs base: `-0.004299`
...
| S2 | 0.580405 | 0.578316 | 0.002089 | best_plus_causal_chain_opportunity |
| S3 | 0.514926 | 0.525120 | -0.010194 | best_plus_sleep_onset_micro_subject_relative |
| S4 | 0.645735 | 0.643246 | 0.002489 | best_plus_sleep_onset_consensus |
...
| S2 | best_plus_causal_chain_opportunity | 2 |
| S2 | best_plus_sleep_consensus_compact_all | 1 |
| S2 | best_plus_sleep_consensus_compact_subject_relative | 1 |
| S2 | boundary_target_map | 1 |
...
| S4 | best_plus_causal_chain_load | 1 |
