...
- Nested selected avg fold loss: `0.622931`
- Delta vs base: `-0.000261`
- Minimum train-fold improvement needed to switch: `0.000500`

## Target Summary

| target | selected_loss | base_loss | delta_vs_base | most_common_family |
| --- | --- | --- | --- | --- |
| Q1 | 0.669009 | 0.669182 | -0.000172 | future |
...
| S4 | 0.646792 | 0.643246 | 0.003545 | best_late_fusion |
