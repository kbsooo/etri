...
- Nested selected avg fold loss: `0.622601`
- Delta vs base: `-0.000591`
- Minimum train-fold improvement needed to switch: `0.001000`

## Target Summary

| target | selected_loss | base_loss | delta_vs_base | most_common_family |
| --- | --- | --- | --- | --- |
| Q1 | 0.671170 | 0.669182 | 0.001988 | best_late_fusion |
...
| S2 | 0.582224 | 0.578316 | 0.003909 | best_late_fusion |
| S3 | 0.525120 | 0.525120 | 0.000000 | best_late_fusion |
| S4 | 0.645007 | 0.643246 | 0.001760 | best_late_fusion |
