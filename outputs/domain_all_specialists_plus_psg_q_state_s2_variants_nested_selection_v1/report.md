...
- Nested selected avg fold loss: `0.618384`
- Delta vs base: `-0.004808`
...
| S2 | 0.573308 | 0.578316 | -0.005007 | protected_state_gate |
...
| S2 | protected_state_gate | 3 |
| S2 | best_plus_protected_state_gate | 2 |
