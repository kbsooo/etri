...
KEY = d.KEY
TARGETS = d.TARGETS
BASE_SUB = OUT / "submission_hybrid_0p588_subject_relative_q.csv"
BASE_OOF = OUT / "final_hybrid_0p588_subject_relative_q_oof.npy"
SUB_OUT = OUT / "submission_hybrid_0p587_subject_relative_qs.csv"
EST_OUT = OUT / "hybrid_0p587_subject_relative_qs_cv_estimate.csv"
OOF_OUT = OUT / "final_hybrid_0p587_subject_relative_qs_oof.npy"

SELECTED = {
    "S2": "center_temp_p0.5_w0.3",
    "S3": "center_temp_p0.5_w0.3",
    "S4": "rank_logit_p0.75_w0.3",
}
