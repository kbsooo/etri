...
KEY = d.KEY
TARGETS = d.TARGETS
BASE_SUB = OUT / "submission_hybrid_0p587_subject_relative_qs.csv"
BASE_OOF = OUT / "final_hybrid_0p587_subject_relative_qs_oof.npy"
SUB_OUT = OUT / "submission_hybrid_0p586_subject_relative_resweep_strict.csv"
EST_OUT = OUT / "hybrid_0p586_subject_relative_resweep_strict_cv_estimate.csv"
OOF_OUT = OUT / "final_hybrid_0p586_subject_relative_resweep_strict_oof.npy"

SELECTED = {
    "Q3": "rank_logit_p0.5_w0.4",
    "S2": "center_temp_p0.25_w0.4",
    "S3": "center_temp_p0.25_w0.4",
    "S4": "rank_logit_p0.5_w0.4",
}
