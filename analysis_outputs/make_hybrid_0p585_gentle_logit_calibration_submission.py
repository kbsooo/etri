...
KEY = d.KEY
TARGETS = d.TARGETS
BASE_SUB = OUT / "submission_hybrid_0p586_subject_relative_resweep_q2loose.csv"
BASE_OOF = OUT / "final_hybrid_0p586_subject_relative_resweep_q2loose_oof.npy"
SUB_OUT = OUT / "submission_hybrid_0p585_gentle_logit_calibration.csv"
EST_OUT = OUT / "hybrid_0p585_gentle_logit_calibration_cv_estimate.csv"
OOF_OUT = OUT / "final_hybrid_0p585_gentle_logit_calibration_oof.npy"
...
SELECTED = {
    ...
    "S2": "scale1.3_shift0_w0.2",
    "S3": "scale1.3_shift0_w0.2",
        ...
        rows.append(
            {
                ...
                "source": f"gentle_logit_{SELECTED[target]}",
            }
        )
