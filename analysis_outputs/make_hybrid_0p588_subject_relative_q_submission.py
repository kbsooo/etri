...
KEY = d.KEY
TARGETS = d.TARGETS
BASE_SUB = OUT / "submission_hybrid_0p588_block_label.csv"
BASE_OOF = OUT / "final_hybrid_0p588_block_label_oof.npy"
SUB_OUT = OUT / "submission_hybrid_0p588_subject_relative_q.csv"
EST_OUT = OUT / "hybrid_0p588_subject_relative_q_cv_estimate.csv"
OOF_OUT = OUT / "final_hybrid_0p588_subject_relative_q_oof.npy"

SELECTED = {
    "Q1": "center_temp_p2_w0.3",
    "Q2": "center_temp_p0.5_w0.3",
    "Q3": "center_temp_p0.5_w0.3",
}
